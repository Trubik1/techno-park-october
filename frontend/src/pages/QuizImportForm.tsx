          ...
          <form className="space-y-6" onSubmit={e => { e.preventDefault(); handlePreview(); }}>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center hover:border-primary/50 hover:bg-primary/5 transition-all duration-200 cursor-pointer min-h-[140px] grid place-content-center">
